...
import ar.edu.unq.groupl.app.model.MailJetUser;
import ar.edu.unq.groupl.app.model.util.ConfigurationLoader;
...
public class EmailSender {
	...
	public EmailSender() throws JSONException {
		client = new MailjetClient(ConfigurationLoader.MAIL_API_KEY_MAILJET, ConfigurationLoader.MAIL_API_SECRET_MAILJET, new ClientOptions("v3.1"));
		mailFrom = createMail(new MailJetUser("Eventeando", ConfigurationLoader.MAIL_ADDRESS_MAILJET));
	}
